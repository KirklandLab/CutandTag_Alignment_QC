...
2A. Clone repository
```
wget https://github.com/JK-Cobre-Help/CutandTag_Analysis_Snakemake/releases/download/v1.0.2/CutandTag_Analysis_Snakemake-1.0.2.tar.gz
refs/tags/v1.0.2.tar.gz
tar -xzf CutandTag_Analysis_Snakemake-1.0.2.tar.gz
rm CutandTag_Analysis_Snakemake-1.0.2.tar.gz
cd CutandTag_Analysis_Snakemake-1.0.2
```
2B. Load modules
```
module purge
