...
```
wget https://github.com/KirklandLab/CutandTag_Alignment_QC/releases/download/v1.1.0/CutandTag_Alignment_QC-1.1.0.tar.gz
tar -xzf CutandTag_Alignment_QC-1.1.0.tar.gz
rm CutandTag_Alignment_QC-1.1.0.tar.gz
cd CutandTag_Alignment_QC-1.1.0
```
9B. Load modules
```
module purge
